...
type UpdateUserInfo struct {
	...
	BirthDat uint64 `protobuf:"varint,4,opt,name=birthDat,proto3" json:"birthDat,omitempty"`
}
...
func (x *UpdateUserInfo) GetBirthDat() uint64 {
	if x != nil {
		return x.BirthDat
	}
	return 0
...
var file_user_proto_rawDesc = []byte{
	...
	0x0e, 0x0a, 0x02, 0x50, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x50, 0x6e, 0x12,
	...
	0x64, 0x65, 0x72, 0x12, 0x1a, 0x0a, 0x08, 0x62, 0x69, 0x72, 0x74, 0x68, 0x44, 0x61, 0x74, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x62, 0x69, 0x72, 0x74, 0x68, 0x44, 0x61, 0x74, 0x22,
...
var file_user_proto_depIdxs = []int32{
	...
	4, // 2: User.GetUserById:input_type -> IdRequest
